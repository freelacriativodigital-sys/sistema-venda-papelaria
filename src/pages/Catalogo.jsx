...
// ============================================================
// MÓDULO: TOPO DO SITE
// Logo + busca + menu de categorias + Banner Hero
// ============================================================
const HeaderSite = ({ st, searchTerm, setSearchTerm, selectedCategory, changeCategory, categorias, isPublic, goHome, view }) => {
  ...
  return (
    <div className="w-full bg-white relative md:sticky top-0 z-40 shadow-sm border-b border-slate-100 flex flex-col">
      ...
      {/* BARRA SUPERIOR (LOGO, BUSCA E WHATSAPP) */}
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 md:py-4 w-full flex items-center justify-between gap-4">
        ...
        {/* Direita: Busca (Desktop) e Botão WhatsApp */}
      ...
      {/* BUSCA MOBILE (Abaixo da logo em telas pequenas) */}
      ...
      {/* HERO SECTION / BANNER DIVIDIDO (Só aparece se tiver banner e estiver na Home) */}
      {view === 'grid' && st?.banner_url && (
        <div className="w-full flex flex-col md:flex-row border-t border-slate-100 overflow-hidden">
          ...
          {/* Lado Direito: A "Parte Colorida" + Imagem do Banner */}
